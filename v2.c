...
//motor speed
//----------------------------------------------------------------------------------------
// int b_rotate = 10;//when it lost line, set motor's current 4:16 (right or left)
// int forward = 25;//typical speed
//
// int b_rotate_2 = 18;
// int forward_2 = 20;
// 
...
// int b_forward = 20;
//-------------------------------------------------------------------------------------------
  int b_rotate = 8;//when it lost line, set motor's current 4:16 (right or left)
 int forward = 16;//typical speed

 int b_rotate_2 = 16;
 int forward_2 = 20;
 
 int b_rotate_3 = 14; //revival
 int forward_3 = 16; //revival
